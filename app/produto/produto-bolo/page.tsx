...
export default function ProdutoBoloCenoura() {
  return (
    <div style={{ maxWidth: '600px', margin: '0 auto' }}>
      ...
      <div style={{ border: '1px solid #eee', padding: '30px', marginTop: '20px', borderRadius: '8px' }}>
        <h1 style={{ marginTop: 0 }}>Bolo de Cenoura</h1>
        <p style={{ color: '#555', lineHeight: '1.6' }}>Delicioso bolo de cenoura fofinho com uma generosa cobertura de chocolate. Perfeito para acompanhar o café da tarde.</p>
        <p style={{ fontSize: '1.5rem', fontWeight: 'bold', color: '#333' }}>R$ 15,00</p>
